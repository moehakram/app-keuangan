...
<head>
    ...
    <title>CashUp - Add Expenditure</title>
        ...
        <nav>
            <ul>
                ...
                <a href="tambahPengeluaran" class="linkAktif">
                    <li id="panel4" class="aktif" style="border-left: 5px solid #A52A2A;">
                        <div style="margin-left: 20px;">
                            <span><i class="fas fa-hand-holding-usd"></i></span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="keperluan" class="form-control" required>
                                            ...
                                            <?php 
                                            $sql = mysqli_query($koneksi, "SELECT * FROM kategori WHERE type = 'expenditure'");
